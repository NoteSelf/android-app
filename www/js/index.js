        ...
        window.plugins.intent.setNewIntentHandler(
            function (Intent) {
                ...
                function defaultTitle(title) {
                    ...
                    var d = new Date();
                    return tw.wiki.generateNewTitle([ "Clip ", 
                            d.getFullYear(), leftPad(d.getMonth() + 1), leftPad(d.getDate()), 
                ...
                var newTiddler = new tw.Tiddler(
                    tw.wiki.getCreationFields(), $tw.wiki.getModificationFields(), fields
                );

                tw.wiki.addTiddler(newTiddler);
                tw.wiki.dispatchEvent({ type: "tm-navigate", navigateTo: fields.title })
            }
        );
